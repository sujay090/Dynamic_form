...
const settingsSchema = new Schema(
    {
        ...
        body: {
            ...
            hero: {
                ...
                backgroundImage: {
                    type: String, // Single background image (legacy support)
                    default: "",
                },
                backgroundImages: [{
                    type: String, // Array of background images for carousel
                }],
                ctaButton: {
                    text: {
                        type: String,
            ...
            services: {
                title: {
                    type: String,
                    default: "Our Services & Courses",
                    trim: true,
                },
                subtitle: {
                    type: String,
                    default: "Explore our comprehensive service and course offerings",
                    trim: true,
                },
                servicesList: [{
                    title: {
                    ...
                    // Type field to distinguish between service and course
                    type: {
                        type: String,
                        enum: ['service', 'course'],
                        default: 'service',
